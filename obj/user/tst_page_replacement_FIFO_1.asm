...
void _main(void)
{
  ...
  80004c:	e8 00 19 00 00       	call   801951 <sys_check_WS_list>
  ...
  80006c:	e8 15 02 00 00       	call   800286 <_panic>
	}
#else
  ...
  800071:	e8 be 13 00 00       	call   801434 <sys_calculate_free_frames>
  800076:	89 45 e8             	mov    %eax,-0x18(%ebp)
	int usedDiskPages = sys_pf_calculate_allocated_pages();
  800079:	e8 01 14 00 00       	call   80147f <sys_pf_calculate_allocated_pages>
  ...
  8000d7:	e8 75 18 00 00       	call   801951 <sys_check_WS_list>
  ...
  8000f7:	e8 8a 01 00 00       	call   800286 <_panic>
	}
	{
  ...
  800117:	e8 6a 01 00 00       	call   800286 <_panic>
  ...
  800137:	e8 4a 01 00 00       	call   800286 <_panic>
	}
  ...
  800144:	e8 fa 03 00 00       	call   800543 <cprintf>
...
libmain(int argc, char **argv)
{
  ...
  80017c:	a3 a0 30 80 00       	mov    %eax,0x8030a0

	//SET THE PROGRAM NAME
	if (myEnv->prog_name[0] != '\0')
  800181:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  800186:	8a 40 5c             	mov    0x5c(%eax),%al
  800189:	84 c0                	test   %al,%al
  80018b:	74 0d                	je     80019a <libmain+0x4b>
		binaryname = myEnv->prog_name;
  80018d:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  800192:	83 c0 5c             	add    $0x5c,%eax
  800195:	a3 8c 30 80 00       	mov    %eax,0x80308c
  ...
  8001a5:	a3 8c 30 80 00       	mov    %eax,0x80308c
  ...
  8001c3:	68 bc 1d 80 00       	push   $0x801dbc
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8002e4:	68 99 1e 80 00       	push   $0x801e99
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80031a:	68 e8 1e 80 00       	push   $0x801ee8
  ...
  800364:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  ...
  800384:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  ...
  8003cd:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  ...
  8003e8:	68 f4 1e 80 00       	push   $0x801ef4
  8003ed:	6a 3a                	push   $0x3a
  8003ef:	68 e8 1e 80 00       	push   $0x801ee8
  ...
  800418:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  ...
  80043e:	a1 a0 30 80 00       	mov    0x8030a0,%eax
  ...
  80045b:	68 48 1f 80 00       	push   $0x801f48
  800460:	6a 44                	push   $0x44
  800462:	68 e8 1e 80 00       	push   $0x801ee8
...
static void putch(int ch, struct printbuf *b) {
  ...
  80049a:	a0 a4 30 80 00       	mov    0x8030a4,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  80050c:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName);
  80050f:	a0 a4 30 80 00       	mov    0x8030a4,%al
  ...
  800531:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  800534:	c6 05 a4 30 80 00 00 	movb   $0x0,0x8030a4
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  800546:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800549:	c6 05 a4 30 80 00 01 	movb   $0x1,0x8030a4
	va_start(ap, fmt);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800638:	05 b4 21 80 00       	add    $0x8021b4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80078b:	8b 04 85 d8 21 80 00 	mov    0x8021d8(,%eax,4),%eax
  ...
  80086c:	8b 34 9d 20 20 80 00 	mov    0x802020(,%ebx,4),%esi
  800873:	85 f6                	test   %esi,%esi
  800875:	75 19                	jne    800890 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800877:	53                   	push   %ebx
  800878:	68 c5 21 80 00       	push   $0x8021c5
  ...
  80088b:	e9 49 02 00 00       	jmp    800ad9 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800890:	56                   	push   %esi
  800891:	68 ce 21 80 00       	push   $0x8021ce
  ...
  8008bc:	75 05                	jne    8008c3 <vprintfmt+0x1a6>
				p = "(null)";
  8008be:	be d1 21 80 00       	mov    $0x8021d1,%esi
			if (width > 0 && padc != '-')
